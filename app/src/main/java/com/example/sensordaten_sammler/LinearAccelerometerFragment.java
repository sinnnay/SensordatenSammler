...
public class LinearAccelerometerFragment extends Fragment implements SensorEventListener, View.OnClickListener  {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View view = inflater.inflate(R.layout.fragment_linearaccelerometer, container, false);
            csvAcc = view.findViewById(R.id.csvBoxLinAcc);
            csvAcc.setEnabled(true);
            startStopBtnAcc = view.findViewById(R.id.bStartStopLinAcc);
            startStopBtnAcc.setOnClickListener(this);
            sampleFreqSpinnerAcc = view.findViewById(R.id.spinnerSampleFreqLinAcc);
            ...
            saveswitch = view.findViewById(R.id.switchsv_Linac);
            return view;
        }
        ...
        public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
            ...
            tvAllDetailsAcc = getActivity().findViewById(R.id.detailsLinAcc);
            tvCsvContent = getActivity().findViewById(R.id.tvSavedCsvFileAcc);
            tvXVal = getActivity().findViewById(R.id.xValueLinAcc);
            tvYVal = getActivity().findViewById(R.id.yValueLinAcc);
            tvZVal = getActivity().findViewById(R.id.zValueLinAcc);
            tvAbsoluteVal = getActivity().findViewById(R.id.absValueLinAcc);
            ...
            sensorToBeListenedTo = MainActivity.sensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION);
        ...
        private void setUpGraphView(){
            graphAcc = (GraphView) getActivity().findViewById(R.id.graphLinAcc);
        ...
        private void setUpGraphView2(){
            graphAcc2 = (GraphView) getActivity().findViewById(R.id.graphLinAcc2);
...
//            }
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.bStartStopLinAcc:
                    if (MainActivity.sensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION) != null) {
                        ...
                        if (buttonText.compareTo(getResources().getString(R.string.start_listening_btn)) == 0) {  // Benutzer hat Start gedrückt
                            ...
                            Sensor sensor = MainActivity.sensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION);
